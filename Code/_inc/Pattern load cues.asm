;NOTES: IDs 26 and 27 used by Resize_GHZ1!!

; ---------------------------------------------------------------------------
; Pattern load cues - index
; ---------------------------------------------------------------------------
	dc.w PLC_Main-ArtLoadCues, PLC_Main2-ArtLoadCues				;1
	dc.w PLC_Explode-ArtLoadCues, PLC_GameOver-ArtLoadCues				;3
	dc.w PLC_GHZ-ArtLoadCues, PLC_GHZ2-ArtLoadCues					;5
	dc.w PLC_LZ-ArtLoadCues, PLC_LZ2-ArtLoadCues					;7
	dc.w PLC_MZ-ArtLoadCues, PLC_MZ2-ArtLoadCues					;9
	dc.w PLC_SLZ-ArtLoadCues, PLC_SLZ2-ArtLoadCues					;B
	dc.w PLC_SYZ-ArtLoadCues, PLC_SYZ2-ArtLoadCues					;D
	dc.w PLC_SBZ-ArtLoadCues, PLC_SBZ2-ArtLoadCues					;F
	dc.w PLC_TitleCard-ArtLoadCues,	PLC_Boss-ArtLoadCues				;11
	dc.w PLC_Signpost-ArtLoadCues, PLC_Warp-ArtLoadCues				;13
	dc.w PLC_SpeStage-ArtLoadCues, PLC_GHZAnimals-ArtLoadCues			;15
	dc.w PLC_LZAnimals-ArtLoadCues,	PLC_MZAnimals-ArtLoadCues			;17
	dc.w PLC_SLZAnimals-ArtLoadCues, PLC_SYZAnimals-ArtLoadCues			;19
	dc.w PLC_SBZAnimals-ArtLoadCues, PLC_SpeStResult-ArtLoadCues			;1B
	dc.w PLC_Ending-ArtLoadCues, PLC_TryAgain-ArtLoadCues				;1D
	dc.w PLC_EggmanSBZ2-ArtLoadCues, PLC_FZBoss-ArtLoadCues				;1F
	dc.w PLC_ABZ-ArtLoadCues, PLC_ABZ2-ArtLoadCues, PLC_ABZAnimals-ArtLoadCues	;22
	dc.w PLC_IC-ArtLoadCues, PLC_IC2-ArtLoadCues, PLC_ICAnimals-ArtLoadCues		;25
	dc.w PLC_GHZ_Main1-ArtLoadCues, PLC_GHZ_Main2-ArtLoadCues			;27
	dc.w PLC_GotThrough-ArtLoadCues							;28
	dc.w PLC_GHZALONE-ArtLoadCues							;29
	dc.w PLC_SZ-ArtLoadCues, PLC_SZ2-ArtLoadCues, PLC_ICAnimals-ArtLoadCues		;2C

PLC_GotThrough:	dc.w 0
		dc.l Nem_GTA
		dc.w $B000
...
PLC_GHZ2:	dc.w 0
		dc.l Nem_MotoFusion	; motofusion enemy
		dc.w $430*$20
;		dc.l Nem_Surf		; Surf patterns
;		dc.w ($310*$20)

PLC_GHZ_Main1:	dc.w 5
...
PLC_ABZ2:	dc.w 3
		...
		dc.w $A660
; ---------------------------------------------------------------------------
; Pattern load cues - Special Zone
; ---------------------------------------------------------------------------
PLC_SZ:		dc.w 0
		dc.l Nem_SZ		; SZ main patterns
		dc.w 0
PLC_SZ2:	dc.w 0
		dc.l Nem_SSEmerald
		dc.w ($56E*$20)
...
;		dc.w $7400
		...
		dc.w $9E00
; ---------------------------------------------------------------------------
; Pattern load cues - Ice Cap
; ---------------------------------------------------------------------------
PLC_IC:		dc.w 0
		dc.l Nem_IC		; ABZ main patterns
		dc.w 0
PLC_IC2:	dc.w 3
		dc.l Nem_MzSwitch	; switch
		dc.w $A260
...
PLC_SLZAnimals:	dc.w 1
		...
		dc.w $B240
; ---------------------------------------------------------------------------
; Pattern load cues - IC animals
; ---------------------------------------------------------------------------
PLC_ICAnimals:	dc.w 1
		dc.l Nem_Pig		; pig
		dc.w $B000
		dc.l Nem_Flicky		; flicky
		dc.w $B240
